...
from group.views import group_contacts
from users.views import user_api,location_api
from rest_framework_jwt.views import obtain_jwt_token,refresh_jwt_token

urlpatterns = [
    path('admin/', admin.site.urls),
    path("group",group_contacts.as_view()),
    path("user",user_api.as_view()),
    path("location",location_api.as_view()),
